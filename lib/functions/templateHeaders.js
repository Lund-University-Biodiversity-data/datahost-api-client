...
function getTemplateXlsxHeader (inputObject) {
  ...
  if (inputObject!="Dataset") {
    ...
    templateXlsxHeader["1.site.anonymizedId2"]="lokal-id internt 2";
    ...
    templateXlsxHeader["1.site.anonymizedId3"]="lokal-id internt 3";
    ...
    templateXlsxHeader["1.site.anonymizedId4"]="lokal-id internt 4";
